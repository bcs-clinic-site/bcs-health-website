...
export default function Volunteer() {
  return (
    <div>
      ...
      <h1 className="text-5xl text-[#4a97b2] mt-20 font-[Bebas_Neue] mx-40">Volunteer Terms</h1>
        <ul className="mx-54 mt-4 text-primary list-disc text-lg">
        ...
        <h1 className="text-5xl text-[#4a97b2] mt-12 font-[Bebas_Neue] mx-40">Positions Available</h1>
        <ul className="mx-54 mt-4 text-primary list-disc text-lg">
        ...
        <h1 className="text-5xl text-[#4a97b2] mt-12 font-[Bebas_Neue] mx-40">Position Requirements</h1>
        <ul className="mx-54 mt-4 text-primary list-disc text-lg">
            ...
            <li>Complete the application form by deadlines; this is non-negotiable</li>
            <ul className="list-disc ml-8">
                <li>
      ...
      <h1 className="text-5xl text-[#4a97b2] mt-20 font-[Bebas_Neue] mx-40">Volunteer Terms</h1>
        ...
        <h1 className="text-5xl text-[#4a97b2] mt-12 font-[Bebas_Neue] mx-40">Positions Available</h1>
        <ul className="mx-54 mt-4 text-primary list-disc text-lg">
            <li>Core Team Intern positions vary depending on current clinic needs, but may include:</li>
            <ul className="list-disc ml-8">
